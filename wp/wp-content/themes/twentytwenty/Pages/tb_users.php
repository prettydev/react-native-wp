                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                <table class="table table-striped table-bordered base-style dataTable" id="user_table">
                                    <thead>
                                        <tr>
                                            <th class="serial">#</th>
                                    ...
                                    <tbody>
										<?php
											...
											for($i=0;$i<count($result);$i++){
												...
												$age = $result[$i]->age;
												$location = '('.$result[$i]->latitude.", ".$result[$i]->longitude.')';
												$dateJoined = $result[$i]->dateJoined;
